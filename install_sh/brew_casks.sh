...
if brew list | grep -q "imageoptim"; then
  showLog "green" "✓ Imageoptim 已安装（跳过）"
else
...
#   showLog "green" "✓ Switchhosts 已安装（跳过）"
# else
